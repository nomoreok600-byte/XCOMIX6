...
<body class="bg-mv-bg text-mv-text font-sans antialiased min-h-screen">
    ...
    <header class="fixed top-0 left-0 right-0 z-[1000] nav-blur bg-mv-bg/80 border-b border-white/[0.04]">
        <nav class="max-w-[1400px] mx-auto flex items-center justify-between h-14 px-3 lg:px-6">
            <!-- Left: Logo -->
            <a href="<?php echo esc_url(home_url()); ?>" class="flex items-center gap-2 shrink-0" aria-label="Home">
            ...
            <div class="flex items-center gap-1">
                <!-- Random Manga -->
                <a href="?random=1" class="h-8 w-8 flex items-center justify-center rounded-full hover:bg-white/5 text-gray-400 hover:text-white transition lg:h-9 lg:w-9" title="Random Manga">
    ...
    <div id="mobileMenu" class="mobile-menu fixed inset-0 z-[999] bg-[#0f0f13]/95 nav-blur flex flex-col p-5">
        ...
        <div class="flex flex-col gap-2 flex-1 overflow-y-auto">
            <a href="<?php echo esc_url(home_url()); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/5 text-lg"><svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>Home</a>
