    ...
    function xcomix_chapter_chat_render($chat, $is_logged_in, $current_user) {
        ...
        if ($chat->comment_parent > 0) {
            ...
            if ($parent_comment) {
                ...
                $reply_html = '
                <div class="flex items-center gap-1.5 text-[11px] text-gray-500 mb-1 pl-2 border-l-2 border-[#3a3a48] select-none">
        ...
        <div id="pages-container" class="mode-webtoon w-full" onclick="window.toggleReaderUI()">
            <?php if (empty($images)) { ?>
                <div class="py-32 text-center flex flex-col items-center justify-center w-full px-6">
                    <div class="w-16 h-16 bg-[#1a1a22] rounded-full flex items-center justify-center mb-4 border border-[#3a3a48]">
